<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report2.aspx.cs" Inherits="CustomReports.Report2" %>
            ...
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem2">
                            <div class="globalReportItemHeader2">
                                <div class="globalHeaderLeft2">设置</div>
                                <div class="globalHeaderMiddle2">&nbsp;</div>
                            </div>
                            <div>
                ...
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem2">
                            <div class="globalReportItemHeader2">
                                <div class="globalHeaderLeft2">Bar报表15</div>
                                <div class="globalHeaderMiddle2">&nbsp;</div>
                                <div style="padding-left:180px; padding-top:10px;">
                                    <button type="button" id="btnSaveAsImage" value="" />
                                </div>
                            </div>
                            <div id="divGlobalReportHTML2"><%=htmlGlobalReportTable2%></div>
                        </div>
                    </td>               
                </tr>
            </table>
