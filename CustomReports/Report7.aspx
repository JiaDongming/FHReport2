<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report7.aspx.cs" Inherits="CustomReports.Report7" %>
...
<head id="Head1" runat="server">
    ...
    <script src="JS/Report7.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="projectReport_107">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem107">
                            <div class="globalReportItemHeader107">
                                <div class="globalHeaderLeft107">设置</div>
                                <div class="globalHeaderMiddle107">&nbsp;</div>
                            </div>
                            <div>
                                        ...
                                        <td>
                                            <div style="top:8px;right:160px;width:230px; float:left;">
                                                <select id="Select1" name="selLift" multiple="multiple" style="width:225px;">
                                                    <%=selProjectOptions107%>
                                                </select>
                                            </div>
                                        </td>
                                        <td style="font-size:15px; padding-left:20px;">排序：</td>  
                                        <td>
                                            <asp:DropDownList class="select" ID="listType" runat="server" AutoPostBack="False">
                ...
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem107">
                            <div class="globalReportItemHeader107">
                                <div class="globalHeaderLeft107">测试报表7</div>
                                <div class="globalHeaderMiddle107">&nbsp;</div>
                            ...
                            <div id="divGlobalReportHTML107"><%=htmlGlobalReportTable107%></div>
                        </div>
                    </td>               
                </tr>
            </table>
