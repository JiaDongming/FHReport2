<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report14.aspx.cs" Inherits="CustomReports.Report14" %>
...
<head id="Head1" runat="server">
    <title></title>
     <meta http-equiv="content-type" content="text/html;chartset=UTF-8" /> 
        ...
        <script src="JS/Report14.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="projectReport_114">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem114">
                            <div class="globalReportItemHeader114">
                                <div class="globalHeaderLeft114">设置</div>
                                <div class="globalHeaderMiddle114">&nbsp;</div>
                            </div>
                            <div>
