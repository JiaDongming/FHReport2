<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report16.aspx.cs" Inherits="CustomReports.Report16" %>
...
<head runat="server">
    ...
    <script src="JS/Report16.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="projectReport_116">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem116">
                            <div class="globalReportItemHeader116">
                                <div class="globalHeaderLeft116">设置</div>
                                <div class="globalHeaderMiddle116">&nbsp;</div>
                            </div>
                            <div>
