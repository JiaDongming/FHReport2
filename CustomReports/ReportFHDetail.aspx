<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportFHDetail.aspx.cs" Inherits="CustomReports.ReportFHDetail" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title><%=UserName%>的工时统计</title>
                    ...
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem101">
                            <div class="globalReportItemHeader101">
                                <div class="globalHeaderLeft101"><%=UserName%></div>
                                <div class="globalHeaderMiddle101">&nbsp;</div>
                               
                            </div>
                            <div id="divGlobalReportHTML101"><%=(htmlGlobalReportTable101.ToString())%></div>
                        </div>
                    </td>               
                </tr>
            </table>
