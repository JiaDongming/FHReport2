<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report20.aspx.cs" Inherits="CustomReports.Report20" %>
...
<head id="Head1" runat="server">
    <title></title>
     <meta http-equiv="content-type" content="text/html;chartset=UTF-8" /> 
        ...
        <script src="JS/Report20.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="projectReport_120">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem120">
                            <div class="globalReportItemHeader120">
                                <div class="globalHeaderLeft120">设置</div>
                                <div class="globalHeaderMiddle120">&nbsp;</div>
                            </div>
                            <div>
