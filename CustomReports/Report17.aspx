<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report17.aspx.cs" Inherits="CustomReports.Report17" %>
...
<head runat="server">
    ...
    <script src="JS/Report17.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="projectReport_117">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem117">
                            <div class="globalReportItemHeader117">
                                <div class="globalHeaderLeft117">设置</div>
                                <div class="globalHeaderMiddle117">&nbsp;</div>
                            </div>
                            <div>
