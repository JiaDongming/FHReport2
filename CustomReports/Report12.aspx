<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report12.aspx.cs" Inherits="CustomReports.Report12" %>
...
<head id="Head1" runat="server">
    <title></title>
     <meta http-equiv="content-type" content="text/html;chartset=UTF-8" /> 
        ...
        <script src="JS/Report12.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="projectReport_112">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem112">
                            <div class="globalReportItemHeader112">
                                <div class="globalHeaderLeft112">设置</div>
                                <div class="globalHeaderMiddle112">&nbsp;</div>
                            </div>
                            <div>
