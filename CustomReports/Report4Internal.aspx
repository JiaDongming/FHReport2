<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report4Internal.aspx.cs" Inherits="CustomReports.Report4Internal" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                ...
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem4">
                            <div class="globalReportItemHeader4">
                                <div class="globalHeaderLeft4">内部工时统计报表</div>
                                <div class="globalHeaderMiddle4">&nbsp;</div>
        ...
        <script src="JS/Report4Internal.js" type="text/javascript"></script>
</body>
</html>
