<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report10.aspx.cs" Inherits="CustomReports.Report10" %>
...
<head runat="server">
    ...
    <script src="JS/Report10.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        <div id="projectReport_110">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem110">
                            <div class="globalReportItemHeader110">
                                <div class="globalHeaderLeft110">Line报表10</div>
                                <div class="globalHeaderMiddle110">&nbsp;</div>
                                <div style="padding-left:180px; padding-top:10px;">
                                    <button type="button" id="btnSaveAsImage" value="" />
                                </div>
                            </div>
                            <div id="divGlobalReportHTML110"></div>
                        </div>
                    </td>               
                </tr>
            </table>
