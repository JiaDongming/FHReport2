<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report19.aspx.cs" Inherits="CustomReports.Report19" %>
...
<head runat="server">
    ...
    <script src="JS/Report19.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="projectReport_119">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem119">
                            <div class="globalReportItemHeader119">
                                <div class="globalHeaderLeft119">设置</div>
                                <div class="globalHeaderMiddle119">&nbsp;</div>
                            </div>
                            <div>
