<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report15.aspx.cs" Inherits="CustomReports.Report15" %>
...
<head runat="server">
    ...
    <script src="JS/Report15.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="projectReport_115">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem115">
                            <div class="globalReportItemHeader115">
                                <div class="globalHeaderLeft115">设置</div>
                                <div class="globalHeaderMiddle115">&nbsp;</div>
                            </div>
                            <div>
