<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report6.aspx.cs" Inherits="CustomReports.Report6" %>
...
<head id="Head1" runat="server">
    ...
    <script src="JS/Report6.js" type="text/javascript"></script>
            ...
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                ...
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem6">
                            <div class="globalReportItemHeader6">
                                <div class="globalHeaderLeft6">测试报表6</div>
                                <div class="globalHeaderMiddle6">&nbsp;</div>
