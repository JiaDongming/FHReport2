<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report13.aspx.cs" Inherits="CustomReports.Report13" %>
...
<head id="Head1" runat="server">
    <title></title>
     <meta http-equiv="content-type" content="text/html;chartset=UTF-8" /> 
        ...
        <script src="JS/Report13.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="projectReport_113">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem113">
                            <div class="globalReportItemHeader113">
                                <div class="globalHeaderLeft113">设置</div>
                                <div class="globalHeaderMiddle113">&nbsp;</div>
                            </div>
                            <div>
