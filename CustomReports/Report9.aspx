<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report9.aspx.cs" Inherits="CustomReports.Report9" %>
...
<head runat="server">
    ...
    <script src="JS/Report9.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        <div id="projectReport_109">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem109">
                            <div class="globalReportItemHeader109">
                                <div class="globalHeaderLeft109">Bar报表9</div>
                                <div class="globalHeaderMiddle109">&nbsp;</div>
                                <div style="padding-left:180px; padding-top:10px;">
                                    <button type="button" id="btnSaveAsImage" value="" />
                                </div>
                            </div>
                            <div id="divGlobalReportHTML109"></div>
                        </div>
                    </td>               
                </tr>
            </table>
