...
function doReportCall() {
    ...
    $.ajax({
        type: "POST",
        url: "Report5.aspx/RefreshGlobalReport5",
        data: params,
        contentType: "application/json; charset=utf-8",
        beforeSend: function (XMLHttpRequest) {
            $('#divGlobalReportHTML5').html("<h5 style='color:red;'>正在生成报表...</h5>");
        },
        success: function (msg) {
            $('#divGlobalReportHTML5').html("");
            if (msg.d) {
                $('#divGlobalReportHTML5').html(msg.d.toString());
            }
        },
